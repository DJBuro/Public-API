...
<div class="siteMessage">
   ...
   <%foreach (var dd in Model.Regions)
      ...
      <div class="regionalColumns">
        <table>
            <tr>
                <td><strong><%=Html.ActionLink(dd.RegionName, "../Display/Region/" + dd.Id.Value.ToString())%></strong></td><td align="center"><strong>Enabled</strong></td>
            </tr>
            <%foreach (SitesRegion sr in dd.SitesRegions)
              {%> 
        <tr>
                <td><%=Html.ActionLink(sr.Site.SiteName, "../Display/Site/" + sr.Site.Id.Value.ToString()) %></td><td align="center"><%= (sr.Site.Enabled) ? "" :"NO" %></td>
            </tr>
            <%
            }%>
        </table>

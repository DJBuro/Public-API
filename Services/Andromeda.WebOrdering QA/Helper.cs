...
namespace Andromeda.WebOrdering
{
    public class Helper
    {
        ...
        public static DomainConfiguration GetDomainConfigurationForHost(string hostHeader)
        {
            ...
            {
                Global.Log.Debug("Getting mapping for " + hostHeader.ToUpper());
                ...
                else
                {
                    ...
                    if (Helper.DomainConfiguration.TryGetValue(defaultMapping.ToUpper(), out domainConfiguration))
                    {
                        domainConfiguration.HostHeader = defaultMapping;
                    }
                    else
                    {
                        Global.Log.Error("Unable to find default mapping for " + defaultMapping);
                    }
                }
                ...
                {
                    Global.Log.Error("Unable to find mapping for " + hostHeader);
                }
                else
                {
                    ...
                    Global.Log.Debug("Using appid: " + domainConfiguration.ApplicationId + ", signpost servers: " + signpostServersText);
                }
            }
        ...
        {
            Global.Log.Debug("GetPaymentProviderDetails");
            ...
            if (success)
            {
                ...
                {
                    // There was a problem
                    Global.Log.Error("GetPaymentProviderDetails GetSiteDetails returned an error.  Json: " + originalSiteDetailsJson);

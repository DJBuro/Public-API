...
{
    internal class OrderTrackingSession
    {
    ...
    {
        public static Dictionary<string, OrderTrackingSession> OrderTrackingSessionLookup { get; set; }
        ...
        static CacheManager()
        {
            ...
            CacheManager.OrderTrackingSessionLookup = new Dictionary<string, OrderTrackingSession>();

...
{
    public class DeliveryTownsServices
    {
        internal static bool GetDeliveryTowns(string key, DomainConfiguration domainConfiguration, out System.Net.HttpStatusCode httpStatus, out string json)
        {
            bool success = false;
            ...
            if (success)
            {
                ...
                foreach (string serverUrl in serverUrls)
                {
                    ...
                    string url = serverUrl + "/deliverytowns?applicationid=" + domainConfiguration.ApplicationId;

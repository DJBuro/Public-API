...
namespace Andromeda.WebOrderTracking
{
    ...
    {
        public static bool GetOrders(string clientWebKey, string credentials, out List<Order> orders)
        {
            bool success = true;
            ...
            if (credentials.Equals("OTTEST", StringComparison.CurrentCultureIgnoreCase))
            {
                ...
                orders = new List<WebOrderTracking.Order>();
                orders.Add(order);
...
and cl.WebKey = '41D38D6A32004c3cBB5A6B552DF5496F'
            ...
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                ...
                SqlParameter webKeySqlParameter = new SqlParameter("@WebKey", clientWebKey);
                sqlCommand.Parameters.Add(webKeySqlParameter);
...
where os.OrderId in (125812,125804)
        ...
        public static bool LogEvent(Exception exception, string extraInfo)
        {
            ...
            success = DataAccess.LogEvent(message, EventTypeEnum.Error, extraInfo, exception.StackTrace);

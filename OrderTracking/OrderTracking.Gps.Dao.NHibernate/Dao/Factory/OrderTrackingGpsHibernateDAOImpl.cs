...
namespace OrderTracking.Gps.Dao.NHibernate.Dao.Factory
{
    ...
    {
        public DeviceDAO(NHibISessionFactory _SessionFactory)
		...
		public  class TrackdataDAO : GenericNHibernateDAO<Trackdata,long?>
			{
			public TrackdataDAO(NHibISessionFactory _SessionFactory)
                : base(_SessionFactory)
            {
			}
		}
        ...
        {
            public GateUserDAO(NHibISessionFactory _SessionFactory)
                : base(_SessionFactory)
            {
            }
        }
        ...
        {
            public UserGroupDAO(NHibISessionFactory _SessionFactory)
                : base(_SessionFactory)
            {
            }
        }
        ...
        {
            public LicenseDAO(NHibISessionFactory _SessionFactory)
                : base(_SessionFactory)
            {
            }
        }
   ...
   /*        /// <summary>
        ...
        {
            public MsgfielddictionaryDAO(NHibISessionFactory _SessionFactory)
                : base(_SessionFactory)
            {
            }
        }
		...
		#endregion
		#region GeocodercacheDAO

		/// <summary>
		/// Geocodercache object for NHibernate mapped table 'geocoder_cache'.
		/// </summary>
		public  class GeocodercacheDAO : GenericNHibernateDAO<Geocodercache,int?>
			{
			public GeocodercacheDAO(String sessionFactoryConfigPath,INHibernateSessionManager _manager) : base(sessionFactoryConfigPath,_manager)
			{
			}
		}

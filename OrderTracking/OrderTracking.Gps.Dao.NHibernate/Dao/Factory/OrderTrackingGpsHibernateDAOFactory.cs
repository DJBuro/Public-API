...
{
    public class OrderTrackingGpsHibernateDAOFactory : AbstractHibernateDAOFactory
    { 
			...
			private GeocodercacheDAO _GeocodercacheDAO;
        ...
        public DeviceDAO DeviceDAO
        {
            get
            {
                if (_DeviceDAO == null) _DeviceDAO = new DeviceDAO(this.SessionFactory);
                return _DeviceDAO;
            }
        }
        ...
        public TrackdataDAO TrackdataDAO
        {
            get
            {
                if (_TrackdataDAO == null) _TrackdataDAO = new TrackdataDAO(this.SessionFactory);
        ...
        public GateUserDAO GateuserDAO
        {
            get
            {
                if (_GateuserDAO == null) _GateuserDAO = new GateUserDAO(this.SessionFactory);
                return _GateuserDAO;
            }
        }
        public UserGroupDAO UserGroupDAO
        {
            get
            {
                if (_userGroupDao == null) _userGroupDao = new UserGroupDAO(this.SessionFactory);
        ...
        public LicenseDAO LicenseDAO
        {
            get
            {
                if (_LicenseDAO == null) _LicenseDAO = new LicenseDAO(this.SessionFactory);
                return _LicenseDAO;
            }
        }
 ...
 /*
        public MsgfielddictionaryDAO MsgfielddictionaryDAO
        {
            get
            {
                if (_MsgfielddictionaryDAO == null) _MsgfielddictionaryDAO = new MsgfielddictionaryDAO(this.SessionFactory);
			...
			public GeocodercacheDAO GeocodercacheDAO
			{
				get
				{
					if (_GeocodercacheDAO == null) _GeocodercacheDAO = new GeocodercacheDAO(this.ConnectionDetails,this.SessionManager);
					return _GeocodercacheDAO;
				}
			}

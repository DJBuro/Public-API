namespace OrderTracking.Gps.Dao.Domain
{
	...
	public  class License
        ...
        //protected int _registeredDevices;
		...
		public License( int licensedusers, int registeredDevices /*, string licenseid, string customerid, string description, string signature, string email, string botype*/ )
		{

...
namespace OrderTracking.Gps.Dao.Domain
{
	...
	public class Trackdata
		...
		public Trackdata( double? longitude, double? latitude, double? altitude, double? heading, double? groundspeed, DateTime? timestamp, int? milliseconds, double? distancenext, short valid)
		{

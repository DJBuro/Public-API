<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchedulertaskparameterForm.ascx.cs" Inherits="OrderTracking.Gps.Data.SchedulertaskparameterForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editSchedulertaskparameterregion fields">

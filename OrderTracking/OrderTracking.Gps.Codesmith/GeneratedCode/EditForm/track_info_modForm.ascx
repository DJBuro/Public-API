<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrackinfomodForm.ascx.cs" Inherits="OrderTracking.Gps.Data.TrackinfomodForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editTrackinfomodregion fields">
				...
				<%# GetMessage("OwneridLabel")%><asp:TextBox ID="OwneridText" runat="server"></asp:TextBox><Cacd:CacdValidationError id="OwneridErrors" runat="server" />

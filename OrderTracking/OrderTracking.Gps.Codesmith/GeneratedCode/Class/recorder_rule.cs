...
namespace OrderTracking.Gps.Dao.Domain
{
	...
	/// </summary>
	public partial  class Recorderrule
		{
		...
		public Recorderrule( string name, string description, short enabled, int? exeorder, string botype, Loadabletype loadabletype, Rulechain rulechain )
		{
			this._name = name;

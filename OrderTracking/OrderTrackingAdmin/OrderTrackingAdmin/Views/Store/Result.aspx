...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%= Html.ActionLink(Html.Resource("Master, Stores"), "/", "Store")%> > <%= Html.ActionLink(Html.Resource("Master, ViewAllStores"), "/All/", "Store")%> > <%=Model.Account.Store.Name %> </h2>
...
<%=Html.Hidden("Id", Model.Account.Store.Id)%>
    ...
    <tr>
         <td><%=Html.TextBox("UserName", Model.Account.UserName)%></td><td><%=Html.TextBox("Password", Model.Account.Password)%></td><td><%=Html.Resource("Master, GpsEnabled")%> <%=Html.CheckBox("GpsEnabled", Model.Account.GpsEnabled)%> </td><td><input type="submit" value="<%= Html.Resource("Master, Update")%>" /></td>
    </tr>
<%
    }
%>

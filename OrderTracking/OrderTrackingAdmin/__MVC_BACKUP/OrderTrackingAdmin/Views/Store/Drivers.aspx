...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%= Html.ActionLink(Html.Resource("Master, Home"), "/", "Store")%> > <%= Html.ActionLink(Html.Resource("Master, ViewAllStores"), "/All/", "Store")%> >  <%= Html.ActionLink(Model.Account.Store.Name, "/FindByExternalId/" + Model.Account.Store.ExternalStoreId, "Store")%> > <%=Html.Resource("Master, Drivers")%></h2>
...
%>        
        ...
        <tr>
            <td><strong><%=driver.Name %></strong></td><td><%= driver.Vehicle %></td><td><%=driver.ExternalDriverId %></td><td><%= driver.Trackers.Count == 0 ? "none":tracker.Name %></td><td><%=driver.DriverOrder.Count %></td>
        </tr> 

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%= Html.ActionLink(Html.Resource("Master, Home"), "/", "Store")%> > <%=Html.Resource("Master, AddNewStore") %></h2>
...
%>
    ...
    <tr class="separator">
        ...
        <tr>
            <td colspan="4"><strong><%=Html.Resource("Master, StoreDetails")%></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4"><strong><%=Html.Resource("Master, Address")%></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4"><strong>Todo: hook up with BT for webservice/email to add trackers</strong></td>
        </tr>
            <tr>

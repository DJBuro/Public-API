...
<div class=""><% if (Model.ErrorMessage != null)
    ...
    <h2><%=Html.Resource("Master, Stores")%></h2>
    ...
    <table>
        ...
        <tr>
           <td><strong><%= Html.ActionLink(Html.Resource("Master, ViewAllStores"), "/All/","Store")%></strong></td><td><strong><%= Html.ActionLink(Html.Resource("Master, AddNewStore"), "Add", "Store")%></strong></td>
        </tr>
        <tr class="separator">
           <td colspan="2"></td>
        </tr>

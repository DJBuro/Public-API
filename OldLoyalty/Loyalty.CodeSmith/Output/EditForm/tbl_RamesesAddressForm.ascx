<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TblRamesesAddressForm.ascx.cs" Inherits="Loyalty.Data.TblRamesesAddressForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editTblRamesesAddressregion fields">

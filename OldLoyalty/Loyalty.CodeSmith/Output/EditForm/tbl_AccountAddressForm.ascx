<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TblAccountAddressForm.ascx.cs" Inherits="Loyalty.Data.TblAccountAddressForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editTblAccountAddressregion fields">

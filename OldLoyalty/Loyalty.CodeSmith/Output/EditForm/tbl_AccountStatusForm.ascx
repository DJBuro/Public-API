<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TblAccountStatusForm.ascx.cs" Inherits="Loyalty.Data.TblAccountStatusForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editTblAccountStatusregion fields">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoyaltyUserForm.ascx.cs" Inherits="Loyalty.Data.LoyaltyUserForm" %>

	<div class="contentForm">
		<h4><asp:Label ID="caption" runat="server"></asp:Label></h4>
        <Cacd:CacdValidationSummary ID="ValidationSummary" runat="server" />
        <div class="editLoyaltyUserregion fields">

...
{
    // AMS_Translation
    internal class AmsTranslationConfiguration : EntityTypeConfiguration<AmsTranslation>
    {
        public AmsTranslationConfiguration()
            : this("dbo")
        {
        }
 
        public AmsTranslationConfiguration(string schema)
        {
            ToTable(schema + ".AMS_Translation");
            HasKey(x => x.LangId);

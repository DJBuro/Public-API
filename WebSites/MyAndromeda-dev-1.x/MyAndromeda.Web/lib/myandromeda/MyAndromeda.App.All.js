...
(function (MyAndromeda) {
    ...
    (function (Start) {
        ...
        controllers.controller("storeListController", function ($scope) {
...
(function (MyAndromeda) {
    var Start;
    (function (Start) {
        var start = angular.module("MyAndromeda.Start", ["MyAndromeda.Start.Controllers", "MyAndromeda.Start.Config"]);

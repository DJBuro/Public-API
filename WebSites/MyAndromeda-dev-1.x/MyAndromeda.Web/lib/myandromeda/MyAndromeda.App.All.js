    ...
    (function (WebOrdering) {
        ...
        (function (UpSelling) {
            ...
            upSellModule.controller("upSellController", function ($scope, $timeout, contextService, upSellDataService, webOrderingWebApiService) {
                ...
                WebOrdering.Logger.Notify('OPTIONS: ');
                WebOrdering.Logger.Notify(multiselectOptions);
                WebOrdering.Logger.Notify('------------');
...
(function (MyAndromeda) {
    ...
    (function (Chain) {
        ...
        (function (Directives) {
            ...
            directives.directive("manageChainUsersLink", function () {
                return {
                    ...
                    controller: function ($scope, $timeout, $http) {
                        ...
                        var route = kendo.format("/user/chain/{0}/count", $scope.chainId);
                        var promise = $http.get(route);
                        promise.then(function (result) {
                            $timeout(function () { context.userCount = result.data.Count; });
                        });
                        $scope.context = context;
                    }
                };
...
(function (MyAndromeda) {
    ...
    (function (Debug) {
        ...
        // Tabs
        gridApp.directive("gridOrderDisplayFoods", function () {
            return {
        ...
        gridApp.directive("gridOrderDisplayDetails", function () {
            return {
                ...
                controller: function ($scope, $timeout, orderService) {
                    var orderId = $scope.orderId;
                    var promise = orderService.GetOrderDetails(orderId);
                    promise.then(function (result) {
                        $timeout(function () {
        ...
        gridApp.directive("gridOrderDisplayPayments", function () {
            return {
                ...
                controller: function ($scope, $timeout, orderService) {
                    var orderId = $scope.orderId;
                    var promise = orderService.GetOrderPayment(orderId);
                    var context = {
                        paymentLines: []
                    };
                    promise.then(function (result) {
        ...
        gridApp.directive("gridOrderDisplayStatuses", function () {
            return {
                ...
                controller: function ($scope, $timeout, orderService) {
                    var orderId = $scope.orderId;
                    var promise = orderService.GetOrderStatus(orderId);
                    var context = {
                        orderStatusHistory: []
                    };
                    promise.then(function (result) {
...
(function (MyAndromeda) {
    ...
    (function (Authorizer) {
        ...
        var AuthorizerService = (function () {
            function AuthorizerService($http) {
                this.$http = $http;
            }
            //to-do 
            AuthorizerService.prototype.AuthorizedFor = function (store, permission) {
                var route = "/authorize/store/permission";
                var data = {
                    Store: store,
            ...
            AuthorizerService.prototype.AuthorizedForAny = function (store, permissions) {
                var route = "/authorize/store/anyPermission";
                var data = {
                    Store: store,
            ...
            AuthorizerService.prototype.CheckStoresAuthorizedFor = function (stores, permission) {
                var route = "/authorize/stores/permission";
                var data = {
                    Stores: stores,
                    Permission: permission
                };
            ...
            AuthorizerService.prototype.CheckStoresAuthorizedForAny = function (stores, permissions) {
                var route = "/authorize/stores/anyPermission";
                var data = {
                    Stores: stores,
                    Permissions: permissions
                };
        ...
        Authorizer.AuthorizerService = AuthorizerService;
        var EnrollmentPermissions = (function () {
            function EnrollmentPermissions() {
            }
            return EnrollmentPermissions;
        }());
        Authorizer.EnrollmentPermissions = EnrollmentPermissions;
        services.service("authorizerService", AuthorizerService);
    })(Authorizer = MyAndromeda.Authorizer || (MyAndromeda.Authorizer = {}));
})(MyAndromeda || (MyAndromeda = {}));
var MyAndromeda;
(function (MyAndromeda) {
    var Services;
            ...
            var MenuControllerService = (function () {
                ...
                MenuControllerService.prototype.initListView = function () {
                    ...
                    var changeHandler = function (e) {
                        var menuItem = this, webNameField = "WebName", descriptionField = "WebDescription", webSequenceField = "WebSequence", enabledField = "Enabled";
                ...
                MenuControllerService.prototype.initListViewItemEvents = function () {
                    ...
                    $(listViewId).on("click", ".k-button-enable", function (e) {
                        ...
                        var menuItem = internal.menuService.menuItemService.findById(id);
                        menuItem.Enable();
                        var all = internal.menuService.menuItemService.getRelatedItems([menuItem]);
    ...
    (function (Menu) {
        ...
        (function (Services) {
            ...
            var PublishingService = (function () {
                function PublishingService(options, menuservice) {
                    ...
                    this.model = kendo.observable({
                        ...
                        publishLaterClick: function () {
                            var publishThumbs = internal.model.get("publishThumbnails"), publishMenu = internal.model.get("publishMenu"), publishNowSelection = internal.model.get("publishNow"), publishOn = internal.model.get("publishOn"), publishNow = publishNowSelection.toLocaleLowerCase() === "now";
                            Menu.Logger.Notify("publish now" + publishNowSelection);
                ...
                PublishingService.prototype.publishNow = function (now, menu, thumbnails, date) {
            ...
            var storeListDataSource = new kendo.data.DataSource({
                transport: {
                    read: function (options) {
                        ...
                        promise.then(function (callback) {
                            options.success(callback.data);
                            MyAndromeda.Logger.Notify("callback");
                            MyAndromeda.Logger.Notify(callback.data);
...
(function (MyAndromeda) {
    ...
    (function (Components) {
        ...
        findStoreComponet.controller("FindStoreController", function ($scope, $timeout, storeService) {
            ...
            searchSubject.debounce(300).distinctUntilChanged(function (e) { return e; }).subscribe(function (searchString) {
                MyAndromeda.Logger.Notify("debounce :" + searchString);
                ...
                var storesPromise = storeService.Find(searchString);
        ...
        findStoreComponet.directive("findStore", function () {
            return {
                name: "findStore",
...
(function (MyAndromeda) {
    ...
    (function (Components) {
        ...
        storeAdminComponent.controller("storeAdminLinkGroupController", function ($scope, $timeout, storeService) {
            MyAndromeda.Logger.Notify("Store assigned? ");
            MyAndromeda.Logger.Notify($scope.store);
            var context = {
                Store: "",
            };
        });
        ...
        storeAdminComponent.directive("storeReportingLinks", function () {
            return {
        ...
        storeAdminComponent.directive("storeAdminGroup", function () {
            return {
    ...
    (function (Store) {
        ...
        (function (Services) {
            ...
            var StoreService = (function () {
                ...
                StoreService.prototype.Find = function (storeName) {
                    var route = "user/stores/find/" + storeName;
                    var promise = this.$http.get(route);
                    return promise;
                };
                StoreService.prototype.FindByAndromedaId = function (andromedaSiteId) {
                    var route = "user/stores/findById/" + andromedaSiteId;
                    var promise = this.$http.get(route);
                    return promise;
                };
                return StoreService;

    ...
    public class CurrentSite : ICurrentSite 
    {
        ...
        public IEnumerable<int> AcsApplicationIds
        {
            get
            {
                ...
                this.acsApplicationIds = this.siteDataService.GetAcsApplicationIds(this.SiteId);
        ...
        public IEnumerable<string> AcsExternalApplicationIds 
        {
            get 
            {
                ...
                this.acsExternalApplicationIds = this.siteDataService.GetExternalAcsApplicationIds(this.SiteId);

                return acsExternalApplicationIds.ToArray();
            }
        }

        private IEnumerable<IEnrolmentLevel> enrolmentLevels;
        ...
        public IEnumerable<AndroWebOrderingWebsite> AndroWebOrderingSites
        {
            get 
            {
                if (this.SiteId == 0)
                {
                    return Enumerable.Empty<AndroWebOrderingWebsite>();
                }

...
namespace MyAndromeda.Framework.Dates
{
    ...
    public class DefaultDateService : IDateServices
    {
        ...
        public int GetWeekOfYear(DateTime? date, CalendarWeekRule calendarWeekRule, DayOfWeek dayOfWeek)
        {
            return this.SiteCalendar.GetWeekOfYear(date.GetValueOrDefault(), calendarWeekRule, dayOfWeek);
        }

...
{
    public class CurrentDateTimeFormatProvider : IDateTimeFormatProvider
    {
        private readonly ILocalizationContext localizationContext;

        public CurrentDateTimeFormatProvider(ILocalizationContext localizationContext)
        {
        ...
        public bool Use24HourTime
        {
            get
            {
                if (ShortTimeFormat.Contains("H")) // Capital H is the format specified for the hour using a 24-hour clock.
                    return true;
                return false;
            }
        }

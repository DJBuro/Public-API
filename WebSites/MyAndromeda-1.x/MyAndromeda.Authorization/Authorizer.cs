...
namespace MyAndromeda.Authorization
{
    public class Authorizer : IAuthorizer
    {
        ...
        public bool AuthorizeAny(params Permission[] anyPermission)
        {
            ...
            { 
                valid = anyPermission
                    ...
                    .Any(exist => permissions.StorePermissions.Any(e => e.Name == exist.Name && e.Category == exist.Category));
            }
        ...
        public bool AuthorizeAll(params Permission[] requiedPermissions)
        {
            ...
            {
                valid = valid && requiedPermissions.Where(e => e.PermissionType == PermissionType.StoreEnrolement)
                    .All(exist => permissions.StorePermissions.Any(e => e.Name == exist.Name && e.Category == exist.Category));
            }
            if (requiedPermissions.Any(e => e.PermissionType == PermissionType.UserRole)) 
            {
                valid = valid && requiedPermissions.Where(e => e.PermissionType == PermissionType.UserRole)
                    .All(exist => permissions.UserPermissions.Any(e => e.Name == exist.Name && e.Category == exist.Category));
            }

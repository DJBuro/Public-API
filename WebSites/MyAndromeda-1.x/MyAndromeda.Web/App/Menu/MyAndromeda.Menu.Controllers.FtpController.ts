...
module MyAndromeda.Menu.Controllers {
    ...
    export class FtpController 
    {
        ...
        public static SetupScope($scope: IFtpControllerScope, $timeout: ng.ITimeoutService, ftpService: MyAndromeda.Menu.Services.FtpService)
        {
            ...
            $scope.CheckDbVersion = () => ftpService.GetFtpVersion();
            ...
            //ftp access status
            ftpService.LocalAccessVersion.subscribe((version) => {
                $timeout(() => { $scope.Version = version; });
            });
...
module MyAndromeda.Menu.Services {
    export class FtpService 
    {
        ...
        public LocalAccessVersion: Rx.Subject<string>;
        ...
        constructor($http: ng.IHttpService)
        {
            ...
            this.LocalAccessVersion = new Rx.Subject<string>();
        ...
        public GetFtpVersion(): void {
            ...
            promise.success((data: string, status, headers, config) => {

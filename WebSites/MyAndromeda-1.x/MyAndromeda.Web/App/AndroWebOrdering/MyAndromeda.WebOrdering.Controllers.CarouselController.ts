...
module MyAndromeda.WebOrdering.Controllers {
    ...
    export class CarouselController {
        ...
        public static LoadImageEditor(
            ...
            var carouselImageUploadUrl = kendo.format("/api/{0}/AndroWebOrdering/{1}/UploadCarouselImage/{2}/{3}", Settings.AndromedaSiteId, Settings.WebSiteId, carousel.Name, item.Id);
        ...
        public static SetupCarousels(
            ...
            $scope.EditCarouselItem = (carouselName: string, carouselItemId: string) => {
                ...
                switch (m.Type.toLowerCase()) {
                    case "image": this.LoadImageEditor($scope, $timeout, c.Carousel, m); break;
                    case "html": this.LoadHtmlEditor($scope, m); break;

...
namespace MyAndromeda.Web.Areas.Store.Controllers
{
    ...
    public class StoreController : Controller
    {
        ...
        public StoreController(WorkContextWrapper workContextWrapper,
            ...
            IStoreOpeningTimesService storeOpeningTimesService)
        {
        ...
        public ActionResult Index(bool? edit)
        {
            ...
            string errorMessage = this.GetSiteModel(site.Id, out siteModel);
            ...
            try
            {
                ...
                if (actionResult == null)
                {
                    ...
                    if (actionResult == null)
                    {
                        ...
                        this.DataAccessFactory.SiteDetailsDataAccess.Update(store.Id, updatedSiteModel.SiteDetails);
        ...
        private string GetSiteModel(int siteId, out SiteModel siteModel)
        {
            ...
            this.DataAccessFactory.SiteDetailsDataAccess.GetBySiteId(siteId, out siteDetails);
        ...
        public ActionResult ChangeAddress(string externalSiteId)
        {
            ...
            try
            {
                ...
                if (actionResult == null)
                {
                    ...
                    this.DataAccessFactory.SiteDetailsDataAccess.GetBySiteId(store.Id, out siteDetails);
                ...
                if (actionResult == null)
                {
                    this.DataAccessFactory.CountryDataAccess.GetAll(out countries);
        ...
        public ActionResult ChangeAddress(MyAndromeda.Web.Models.AddressModel addressModel)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    this.DataAccessFactory.AddressDataAccess.UpsertBySiteId(store.Id, addressModel.Address);

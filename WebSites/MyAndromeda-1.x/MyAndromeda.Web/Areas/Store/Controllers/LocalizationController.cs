...
namespace MyAndromeda.Web.Areas.Store.Controllers
{
    public class LocalizationController : Controller
    {
        ...
        public LocalizationController(ICurrentSite currentSite, IStoreDataService storeDataService, INotifier notifier, ISynchronizationTaskService synchronizationTaskService, ICurrentUser currentUser) 
        {

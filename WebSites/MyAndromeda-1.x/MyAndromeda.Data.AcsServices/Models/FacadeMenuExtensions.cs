...
{
    public static class FacadeMenuExtensions
    {
        ...
        public static MyAndromedaMenuItem Transform(this RawMenuItem item,
            IList<string> names,
            ...
            IDictionary<int, IList<ThumbnailImage>> menuItemThumbnails)
        {
            ...
            oItem.Toppings.Fill(item, toppings);

            return oItem;
        }

        public static void Fill(this MyAndromedaToppings toppings, RawMenuItem menuItem, IDictionary<int, MyAndromedaTopping> lookup)
        {
            foreach (var t in menuItem.DefTopIds) 
            {
                toppings.DefaultToppings.Add(lookup[t]);
            }

            foreach (var t in menuItem.OptTopIds) 
            {
                toppings.OptionalToppings.Add(lookup[t]);
            }
        }

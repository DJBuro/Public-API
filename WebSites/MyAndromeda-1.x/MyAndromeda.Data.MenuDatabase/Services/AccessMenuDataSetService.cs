...
namespace MyAndromeda.Data.MenuDatabase.Services
{
    public class AccessMenuDataSetService : IAccessMenuDataSetService 
    {
        ...
        public AccessMenuDataSetService(WorkContextWrapper workContextWrapper, IMyAndromedaLogger logger) : this(logger)
        {
        ...
        public AccessMenuDataSetService(IMyAndromedaLogger logger) 
        {
            this.logger = logger;
        }

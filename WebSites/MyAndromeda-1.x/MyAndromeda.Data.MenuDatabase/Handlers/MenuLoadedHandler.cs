...
namespace MyAndromeda.Data.MenuDatabase.Handlers
{
    public class MenuLoadedHandler : IMenuLoadingEvent
    {
        ...
        public MenuLoadedHandler(IAccessDbMenuVersionDataService accessMenuVersionService,
        ...
        private void FillMenuFromAccessDbMenuItems(MyAndromedaMenu menu)
        {
            ...
            foreach (var menuItem in menu.MenuItems)
            {
                ...
                var menuRow = this.accessMenuItemDataService.List(e => e.nUID == menuItem.Id).SingleOrDefault();
                if (menuRow != null)
                {
                    ...
                    {
                        Collection = (decimal)prices.Collection / 100,
                        Delivery = (decimal)prices.Delivery / 100,
                        Instore = (decimal)prices.InStore / 100
                    };

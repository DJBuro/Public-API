...
{
    // storegroup
    internal partial class StoregroupConfiguration : EntityTypeConfiguration<Storegroup>
    {
        public StoregroupConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".storegroup");
            HasKey(x => x.Recordid);

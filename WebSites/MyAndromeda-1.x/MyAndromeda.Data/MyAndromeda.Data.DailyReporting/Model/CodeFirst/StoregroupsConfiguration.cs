...
{
    // storegroups
    internal partial class StoregroupsConfiguration : EntityTypeConfiguration<Storegroups>
    {
        public StoregroupsConfiguration(string schema = "dbo")
        {
            ...
            Property(x => x.Groupposition).HasColumnName("groupposition").IsOptional();
            Property(x => x.Groupcategory).HasColumnName("groupcategory").IsOptional().HasMaxLength(100);
            Property(x => x.Groupname).HasColumnName("groupname").IsOptional().HasMaxLength(100);
            ...
            Property(x => x.Userdef2).HasColumnName("userdef2").IsOptional().HasMaxLength(100);
            InitializePartial();
        }

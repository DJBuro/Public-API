...
{
    // dailysummary_vw
    public partial class DailysummaryVw
    {
        ...
        public DateTime? CreateTimeStamp { get; set; } // Create_TimeStamp
        public DateTime? UpdateTimeStamp { get; set; } // Update_TimeStamp
        public string NCustomerId { get; set; } // nCustomerID

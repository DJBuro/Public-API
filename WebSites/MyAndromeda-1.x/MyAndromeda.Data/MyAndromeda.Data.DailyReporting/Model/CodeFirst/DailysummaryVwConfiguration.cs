...
{
    // dailysummary_vw
    internal partial class DailysummaryVwConfiguration : EntityTypeConfiguration<DailysummaryVw>
    {
        public DailysummaryVwConfiguration(string schema = "dbo")
        {
            ...
            Property(x => x.StoreName).HasColumnName("StoreName").IsOptional().HasMaxLength(100);

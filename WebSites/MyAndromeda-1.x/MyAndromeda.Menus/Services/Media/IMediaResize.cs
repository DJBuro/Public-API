...
namespace MyAndromeda.Menus.Services.Media
{
    ...
    public class MediaResizeService : IMediaResizeService 
    {
        ...
        private readonly IMyAndromedaMenuItemDataService menuItemDataAccess;
        private readonly IMyAndromedaMediaProfilesDataService mediaProfileDataService;

        public MediaResizeService(IMyAndromedaMenuItemDataService menuDataAccess, IMyAndromedaMediaProfilesDataService mediaProfileDataService, IMyAndromedaSiteMenuDataService siteMenuDataAccess) 
        {

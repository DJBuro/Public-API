var helper =
{
    ...
    clearOrder: function ()
    {
        ...
        // Remove any auto applied voucher
        AndroWeb.Helpers.CartHelper.removeAutoAppliedVoucher();
    ...
    gotoParentWebsite: function()
    {
        if (settings.parentWebsite == undefined || settings.parentWebsite == "undefined" || settings.parentWebsite.length === 0)
        {
            // No parent website set so just go to the root domain
    ...
    repeat: function(character, iterations)
    {
        var result = '';

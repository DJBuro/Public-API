...
(
    ...
    function ()
    {
        ...
        // The test
        var amount = AndroWeb.Helpers.CartHelper.calculateFullOrderDiscount(500);
...
(
    ...
    function ()
    {
        ...
        // The test
        var amount = menuHelper.calculateDealLinePrice(bindableDealLine, false);
        equal(amount, 2778, "Expected 2778 but got " + amount);
    }
);

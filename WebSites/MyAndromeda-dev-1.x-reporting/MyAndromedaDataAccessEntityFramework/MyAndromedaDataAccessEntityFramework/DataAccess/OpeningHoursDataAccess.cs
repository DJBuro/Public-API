...
namespace MyAndromeda.Data.DataAccess
{
    ...
    {
        public IEnumerable<Data.Domain.TimeSpanBlock> ListBySiteId(int siteId) 
        {
            IEnumerable<Data.Domain.TimeSpanBlock> results = Enumerable.Empty<Data.Domain.TimeSpanBlock>();
            ...
            { 
                ...
                {
                    results = openingHours.Select(e => new Data.Domain.TimeSpanBlock
                    {
                        Id = e.Id,
                        Day = e.Description,
        ...
        /// <param name="siteId"></param>
        /// <returns></returns>
        public string Add(int siteId, Data.Domain.TimeSpanBlock timeSpanBlock)
        {
            using (var entitiesContext = new AndroAdminDbContext())
            {
                // Get the store

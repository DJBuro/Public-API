...
using Domain = MyAndromeda.Data.Domain.Marketing;
...
namespace MyAndromeda.Data.DataAccess.Marketing
{
    ...
    {
        public IEnumerable<Data.Domain.Marketing.EmailCampaignTask> GetTasksBySiteId(int siteId)
        {
        ...
        public void Update(Data.Domain.Marketing.EmailCampaignTask campaign)
        {
            using (var dbContext = new MyAndromedaDbContext()) 
            {
        ...
        public void Create(Data.Domain.Marketing.EmailCampaignTask campaignTask)
        {
            using (var dbContext = new MyAndromedaDbContext()) 
            {
        ...
        /// <returns></returns>
        public IEnumerable<Data.Domain.Marketing.EmailCampaignTask> GetTasksToRun(DateTime dateTime, bool? started, bool? completed)
        {
            using (var dbContext = new MyAndromedaDbContext())
            {
        ...
        public void SetAsRunning(IEnumerable<Data.Domain.Marketing.EmailCampaignTask> campaignsToSend)
        {
            using (var dbContext = new MyAndromedaDbContext()) 
            {
                int[] ids = campaignsToSend.Select(e => e.Id).ToArray();
        ...
        public void UpdateBatch(IEnumerable<Data.Domain.Marketing.EmailCampaignTask> campaignsToSend)
        {
            using (var dbContext = new MyAndromedaDbContext())
            {
                int[] ids = campaignsToSend.Select(e => e.Id).ToArray();

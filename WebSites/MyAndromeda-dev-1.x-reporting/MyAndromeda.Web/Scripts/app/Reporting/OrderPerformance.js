...
(function (MyAndromeda) {
    (function (Data) {
        ...
        Data.dailySummaryDataService = dailySummaryDataService;
    })(MyAndromeda.Data || (MyAndromeda.Data = {}));
    var Data = MyAndromeda.Data;
        ...
        (function (Reporting) {
            var dailyPerformanceService = (function () {
                function dailyPerformanceService(options) {
                    ...
                    this.options = options;
                    this.dashboardSalesService = new MyAndromeda.Data.dailySummaryDataService(options);
                    this.bound = false;
                }
            ...
            Reporting.dailyPerformanceService = dailyPerformanceService;

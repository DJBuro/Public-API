...
namespace MyAndromeda.Web.Areas.DeliveryZone.Controllers
{
    public class DeliveryZoneController : Controller
    {
        ...
        public ActionResult Index(Model.DeliveryAreaViewModel deliveryZone)
        {
            ...
            {
                deliveryZone.DeliveryAreasList = deliveryZone.DeliveryAreas.Split(new string[] { System.Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries)
                   .ToArray()
                   .Select(s => s.Trim())
            ...
            else
            {
                ...
                {
                    //get data version
                    int version = MyAndromeda.Data.Model.DataVersionHelper.GetNextDataVersion(new AndroAdminDbContext());

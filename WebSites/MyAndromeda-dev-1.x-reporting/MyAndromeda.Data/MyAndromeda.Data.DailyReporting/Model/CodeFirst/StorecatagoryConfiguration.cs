...
{
    // storecatagory
    internal class StorecatagoryConfiguration : EntityTypeConfiguration<Storecatagory>
    {
        public StorecatagoryConfiguration()
            : this("dbo")
        {
        }
 
        public StorecatagoryConfiguration(string schema)
        {

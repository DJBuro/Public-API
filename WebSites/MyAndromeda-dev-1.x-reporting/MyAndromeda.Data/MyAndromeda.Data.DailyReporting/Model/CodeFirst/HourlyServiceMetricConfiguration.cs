...
namespace MyAndromeda.Data.DailyReporting.Model.CodeFirst
{
    ...
    internal class HourlyServiceMetricConfiguration : EntityTypeConfiguration<HourlyServiceMetric>
    {
        public HourlyServiceMetricConfiguration()
            : this("dbo")
        {
        }
 
        public HourlyServiceMetricConfiguration(string schema)
        {
            ToTable(schema + ".HourlyServiceMetrics");
            HasKey(x => new { x.Thedate, x.NStoreId, x.Thehour });
            ...
            Property(x => x.Thehour).HasColumnName("thehour").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            Property(x => x.Thedate).HasColumnName("thedate").IsRequired().HasColumnType("date").HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            Property(x => x.TotalTime).HasColumnName("TotalTime").IsOptional().HasColumnType("int");
            ...
            Property(x => x.DriveThruCount).HasColumnName("DriveThruCount").IsOptional().HasColumnType("int");

...
{
    // dailysummary_vw
    internal class DailysummaryVwConfiguration : EntityTypeConfiguration<DailysummaryVw>
    {
        public DailysummaryVwConfiguration()
            : this("dbo")
        {
        }
 
        public DailysummaryVwConfiguration(string schema)
        {
            ToTable(schema + ".dailysummary_vw");
            HasKey(x => new { x.Id, x.RecordId });
            ...
            Property(x => x.StoreName).HasColumnName("StoreName").IsOptional().HasColumnType("nvarchar").HasMaxLength(100);
            ...
            Property(x => x.CreateTimeStamp).HasColumnName("Create_TimeStamp").IsOptional().HasColumnType("datetime");
            Property(x => x.UpdateTimeStamp).HasColumnName("Update_TimeStamp").IsOptional().HasColumnType("datetime");
            Property(x => x.NCustomerId).HasColumnName("nCustomerID").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(8);

...
{
    // kfc_createorder
    internal class KfcCreateorderConfiguration : EntityTypeConfiguration<KfcCreateorder>
    {
        public KfcCreateorderConfiguration()
            : this("dbo")
        {
        }
 
        public KfcCreateorderConfiguration(string schema)
        {
            ToTable(schema + ".kfc_createorder");
            ...
            Property(x => x.StrOrderaddressnotes).HasColumnName("str_orderaddressnotes").IsOptional().HasColumnType("nvarchar").HasMaxLength(192);
            ...
            Property(x => x.StrDatacashid).HasColumnName("str_datacashid").IsOptional().HasColumnType("nvarchar").HasMaxLength(255);
            ...
            Property(x => x.Entrydate).HasColumnName("entrydate").IsOptional().HasColumnType("datetime");
            Property(x => x.Editdate).HasColumnName("editdate").IsOptional().HasColumnType("datetime");
            Property(x => x.Username).HasColumnName("username").IsOptional().HasColumnType("nvarchar").HasMaxLength(32);
            Property(x => x.Machine).HasColumnName("machine").IsOptional().HasColumnType("nvarchar").HasMaxLength(32);

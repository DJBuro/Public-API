...
(function (MyAndromeda) {
    ...
    (function (Marketing) {
        ...
        var moduleName = "MyAndromeda.MarketingThing";
        ...
        m.controller("UnregisteredController", function ($scope) {
            MyAndromeda.Logger.Notify("UnregisteredController");
        });
        m.controller("SevenDaysNoOrderController", function ($scope) {
            MyAndromeda.Logger.Notify("SevenDaysNoOrderController");
        });
        m.controller("StartController", function ($scope, $timeout, resizeService, progressService) {
        ...
        m.directive("updateBodyContent", function () {
            return {
        ...
        m.directive("contactTemplate", function () {
            return {
                ...
                controller: function ($scope, marketingEventService) {
        ...
        m.directive("eventTemplate", function () {
            return {
                name: "eventTemplate",
                restrict: "E",
                "require": [
        ...
        Marketing.Routes = {
            ContactRoute: "/api/{0}/marketing/contact",
            RegisteredAndInactiveRoute: "/api/{0}/marketing/noorders",
            InactiveForSevenDaysRoute: "/api/{0}/marketing/oneweek",
            InactiveForOneMonthRoute: "/api/{0}/marketing/onemonth",
            InactiveForThreeMonthsRoute: "/api/{0}/marketing/threemonth",
            Save: "/api/{0}/marketing/saveevent",
            Preview: "/api/{0}/marketing/preview"
        };

...
{
    /// <summary>
    /// Provides a set of properties which control the formatting of dates and times in MyAndromeda.
    /// </summary>
    public interface IDateTimeFormatProvider : IDependency
    {
        ...
        /// </summary>
        IEnumerable<string> MonthNames { get; }

        /// <summary>
        /// Gets a list of abbreviated month names.
        /// </summary>
        IEnumerable<string> MonthNamesShort { get; }

        /// <summary>
        /// Gets a list of weekday names.
        /// </summary>
        IEnumerable<string> DayNames { get; }

        /// <summary>
        /// Gets a list of abbreviated weekday names.
        /// </summary>
        IEnumerable<string> DayNamesShort { get; }

        /// <summary>
        /// Gets a list of maximally abbreviated weekday names.
        /// </summary>
        IEnumerable<string> DayNamesMin { get; }
        ...
        /// </summary>
        IEnumerable<string> AmPmDesignators { get; }
    }
}
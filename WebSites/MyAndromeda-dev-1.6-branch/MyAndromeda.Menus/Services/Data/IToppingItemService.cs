...
namespace MyAndromeda.Menus.Services.Data
{
    public interface IToppingItemService : IDependency
    {
        ...
        Task UpdateAccessDatabaseMenuItemsAsync(IEnumerable<MyAndromedaTopping> clientMenuItems);
    }
    ...
    public class UpdateToppingItemService : IToppingItemService
    {
        ...
        public async Task UpdateAccessDatabaseMenuItemsAsync(IEnumerable<MyAndromedaTopping> clientMenuItems)
        {
            ...
            {
                await changeEventHandler.UpdatedToppingsAsync(eventMessage);
            }
        }
    }
}

...
namespace MyAndromeda.Data.AcsServices.Services
{
    ...
    public class AndroClousApiServiceDataAccess : IAndroCloudApiServiceDataAccess
    {
        ...
        public AndroClousApiServiceDataAccess(
            ISignPostUrlService signPostUrlService, 
        ...
        public async Task<string> FetchServerAddressesAsync(string applicationId)
        {
            ...
            var result = await queryServicesTask;

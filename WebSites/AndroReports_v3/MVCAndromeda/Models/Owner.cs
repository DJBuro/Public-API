...
namespace MVCAndromeda.Models
{
    public class Owner
    {
        ...
        //------------  Constructor----------------------------------------
        public Owner(string name, string countryFilter, Dictionary<string, List<string>> countriesAndStores)
        {
            Name = name;
            ...
            foreach (var cs in CountriesAndStores.Where(e => { if (string.IsNullOrWhiteSpace(countryFilter)) return true; return e.Key == countryFilter; }))
            {

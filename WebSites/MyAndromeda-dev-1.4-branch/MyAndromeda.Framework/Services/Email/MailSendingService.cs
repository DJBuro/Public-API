...
namespace MyAndromeda.Framework.Services.Email
{
    public class MailSendingService : IMailSendingService
    {
        ...
        private ConcurrentDictionary<Guid, bool> Status;
        ...
        { 
            ...
            this.Status = new ConcurrentDictionary<Guid, bool>();
        }
        ...
        public void SendPreviewEmail(EmailCampaign model, EmailSettings settings, string emailTo)
        {
            ...
            //this.SendEmails(model, settings, testPool, too);
        }

        public void SendCampaignEmail(EmailCampaign model, EmailSettings settings = null)
        {
        ...
        public void SendEmails(EmailCampaign model, EmailSettings settings, IEnumerable<Customer> users, string[] overideTo = null)
        {
            ...
            foreach (var message in messages)
            {
                ...
                this.mailSender.Send(overideTo ?? 
                    new[] { 
                        message.Customer.ContactDetails

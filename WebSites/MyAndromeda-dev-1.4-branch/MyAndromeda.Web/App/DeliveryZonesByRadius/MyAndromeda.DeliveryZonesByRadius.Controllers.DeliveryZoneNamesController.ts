...
module MyAndromeda.DeliveryZonesByRadius.Controllers {
    ...
    export class DeliveryZoneNamesController {
        ...
        public static SetupSubscriptions(
            ...
            $timeout: ng.ITimeoutService,
            contextService: Services.ContextService,
            deliveryZonesByRadiusApiService: Services.DeliveryZonesByRadiusWebApiService): void
        {
            ...
            var savingSubscription = deliveryZonesByRadiusApiService.IsSavingBusy.distinctUntilChanged(e=> e).subscribe((value) => {
                $timeout(() => {

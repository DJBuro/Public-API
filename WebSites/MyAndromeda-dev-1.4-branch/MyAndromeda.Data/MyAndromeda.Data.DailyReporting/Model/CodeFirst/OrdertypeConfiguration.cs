...
{
    // ordertype
    internal partial class OrdertypeConfiguration : EntityTypeConfiguration<Ordertype>
    {
        public OrdertypeConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".ordertype");
            HasKey(x => x.Recordid);

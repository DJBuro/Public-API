...
namespace MyAndromedaMembershipProvider.Services
{
    public class MembershipService : IMembershipService
    {
        ...
        public bool SetPassword(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord entity, string password, bool saveChanges = true)
        {
            var context = new UserEventContext()
            {
        ...
        private static void SetPasswordClear(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord partRecord, string password)
        {
        ...
        private static bool ValidatePasswordClear(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord partRecord, string password)
        {
            return partRecord.Password == password;
        }

        private static void SetPasswordHashed(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord entity, string password)
        {
        ...
        private static bool ValidatePasswordHashed(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord partRecord, string password)
        {
        ...
        private bool ValidatePassword(MyAndromedaDataAccessEntityFramework.Model.MyAndromeda.UserRecord entity, string password)
        {

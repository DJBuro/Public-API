...
function ToppingsWrapperViewModel(showCartItem, showPopupCallback, dealDetails)
{
    "use strict";
    ...
    self.popupViewModel = ko.observable(new ToppingsViewModel(showCartItem, showPopupCallback, dealDetails));
};

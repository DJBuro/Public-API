...
function LoginViewModel(isCheckoutLogin)
{
                ...
                (
                    ...
                    function (putCustomerResponse)
                    {
                        if (putCustomerResponse === undefined || putCustomerResponse === null)
                        {
                            ...
                            viewModel.pageManager.showPage('Login', true, self);
                        }
                        else
                        {
    ...
    {
        viewModel.telemetry.sendTelemetryData('Account', 'Login', 'Facebook');
    ...
    self.login = function ()
    {
        viewModel.telemetry.sendTelemetryData('Account', 'Login', 'Andro');
    ...
    self.loginCallback = function (success, pleaseWaitViewModel)
    {
        if (success)
        {
            viewModel.telemetry.sendTelemetryData('Account', 'Login', 'Success');

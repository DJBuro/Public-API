var dealPopupHelper =
{
    ...
    showDealPopup: function (mode, scrollTop, cartDeal)
    {
        ...
        if (guiHelper.isMobileMode())
        {
            ...
            // The deal popup view model needs to go into a wrapper object.  This is because the same toppings popup html is used in both a popup as
    ...
    hideDealPopup: function (isCancel)
    {
        ...
        {
            viewModel.pageManager.showPage('Menu/Deals', true);
        }

...
var acsapi =
{
    ...
    getSiteList: function (callback, errorCallback, deliveryZone)
    {
        ...
        (
            function (data, textStatus, jqXHR)
            {
                ...
                {
                    if (data === null || textStatus !== 'success') {
                        guiHelper.showError(textStrings.errProblemGettingSites, errorCallback, exception);
                    }
                    else
                    {
                        // Start fresh
    ...
    putDataCashPayment: function (siteId, callback, errorCallback)
    {
        ...
        (
            {
                ...
                dataType: 'json',
                cache: false,
                data: '{ "amount": "' + cartHelper.cart().totalPrice() + '", "returnUrl": "' + window.location.href + '/Done.html", "browserUserAgent": "' + encodeURIComponent(navigator.userAgent) + '" }'
            }
        )
        .done
        (
    ...
    getCustomer: function (username, password, callback, errorCallback)
    {
    ...
    putCustomer: function (username, password, customer, callback, errorCallback)
    {
        // Call the Customers web service
        var jqxhr = $.ajax
        (

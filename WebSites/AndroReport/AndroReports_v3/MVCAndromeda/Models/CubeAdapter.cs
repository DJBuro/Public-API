...
namespace MVCAndromeda.Models
{
    public class CubeAdapter
    {
        ...
        private List<string> getAllOwnerChainDescendants(List<string> chains)
        {
        ...
        private List<string> getAllLeafChains()
        {
        ...
        public void fillStoreMeasures(DateTime today, ref Owner owner, string term, int unitsAgo)
        {
        ...
        public Store fillStoreMeasures(DateTime today, string storeName, string country, string term, int unitsAgo)
        {
        ...
        private List<List<long?>> getStoreMeasures(DateTime today, List<string> storeNames, string term, string measure, int unitsAgo)
        {
            ...
            for (int storeIndex = 0; storeIndex < (dataTable.Columns.Count) - startIndex; storeIndex++)
            {
                ...
                //  loop ofer date rows: one rows for Day, Month, Year, 7 for Week Day, 11 for Month of year

...
namespace mdx
{
    public class DateUtilities
    {
        ...
        public static void ParseDate(string term, int unitsAgo, out string day, out string week, out string month, out string year,
            out int intWeek, out int intYear, out Boolean firstNonFullWeek, out Boolean lastNonFullWeek)
        {
            const int daysInWeek = 7;
            day = week = month = year = "";

            DateTime today = DateTime.Now;
            today = Convert.ToDateTime("25 August 2013");//test
           
 today = Convert.ToDateTime("18 September 2013");//test
            DateTime date = today;
        ...
        public static string getDateDescription(string term, int unitsAgo, Boolean fullFirstWeek = false)
        {
            string year, day, week, month;
            int intWeek, intYear;
            Boolean dummy;
            ParseDate(term, unitsAgo, out day, out week, out month, out year, out intWeek, out intYear, out dummy, out dummy);

...
[assembly: WebActivator.PreApplicationStartMethod(typeof(MVCAndromeda.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivator.ApplicationShutdownMethodAttribute(typeof(MVCAndromeda.App_Start.NinjectWebCommon), "Stop")]
namespace MVCAndromeda.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            //to work when the app needs a logger that isnt injected through the constructor
            ...
            kernel.Bind<RouteData>().ToMethod((c) => {
                ...
                return routeCollection.GetRouteData(httpContextWrapper);
            });

var dealHelper =
{
    ...
    addToCart: function (context)
    {
        ...
        if (deal.isEnabled() &&
            ...
            ((viewModel.orderType() == 'delivery' && deal.deal.ForDelivery) || (viewModel.orderType() == 'collection' && deal.deal.ForCollection) || (viewModel.orderType() == 'dinein' && deal.deal.ForDineIn)))
        {
            var cartDealWrapper = { mode: 'addDeal', cartDeal: new AndroWeb.Models.CartDeal(deal) };

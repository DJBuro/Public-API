...
{  
    ...
    {
        guiHelper.showView('loginView', viewModel === undefined ? new AndroWeb.ViewModels.LoginViewModel(false) : viewModel, true);
    },
    showMyProfile: function (state)
    {
        guiHelper.showView('myProfileView', new MyProfileViewModel(state), true);
    },
    showMyOrders: function ()
    {
        guiHelper.showView('myOrdersView', new MyOrdersViewModel(), true);
    },
    ...
    {
        guiHelper.showView('pleaseWaitView', viewModel === undefined ? new AndroWeb.ViewModels.PleaseWaitViewModel() : viewModel, undefined);
    },

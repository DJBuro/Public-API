...
class settings
{
    ...
    static sendDineInOrdersAsDelivery: boolean = false;
    static generateTestPerson: boolean = false;
    static generateTestEventName: boolean = false;

    /* Header */
    static isPageHeaderVisible: boolean = true;
    ...
    static deliveryCharge: number = undefined; // The decimal delivery charge (if a delivery charge needs to be applied)
    static optionalFreeDeliveryThreshold: number = undefined; // If the total order value is less this value then apply the delivery charge
    static cardCharge: number = undefined; // The decimal card charge (if a card charge needs to be applied)
    ...
    /* Occasions */
    static enableDelivery: boolean = true; // False when delivery is not allowed
    static enableCollection: boolean = true; // False when collection is not allowed
    static enableDineIn: boolean = false; // False when dine in is not allowed
    ...
    static areToppingSwapsEnabled: boolean = false; // Enable or disable topping swaps
    ...
    /* Upselling */
    static isUpsellEnabled: boolean = false;
    static upsellingCategories: any[] = null;

    /* Facebook share */
    static isFacebookShareEnabled: boolean = false;
    static facebookShareCaption: string = '';
    static facebookShareDescription: string = '';
};
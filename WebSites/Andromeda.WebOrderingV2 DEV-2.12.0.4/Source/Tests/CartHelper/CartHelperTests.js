...
(
    ...
    {
        // The test
        var amount = AndroWeb.Helpers.CartHelper.getOrderValueExcludingDealsWithAMinimumPrice();
...
(
    ...
    function ()
    {
        ...
        AndroWeb.Helpers.CartHelper.cart().deals().push
        (
            {
...
(
    ...
    function ()
    {
        // Setup
        viewModel.orderType('Delivery');
        AndroWeb.Helpers.CartHelper.cart().cartItems().push
        (
            {
...
(
    ...
    function ()
    {
        ...
        // The test
        var amount = AndroWeb.Helpers.CartHelper.calculateFullOrderDiscount(0);
        equal(amount, 0, "Expected 0 but got " + amount);
    }
);
...
(
    ...
    function ()
    {
        ...
        // The test
        var amount = AndroWeb.Helpers.CartHelper.calculateFullOrderDiscount(100);

...
function DataCashPaymentViewModel()
{
    ...
    self.onShown = function ()
    {
        ...
        iFrame.attr('src', AndroWeb.Helpers.CartHelper.cart().dataCashPaymentDetails().url + '?HPS_SessionID=' + AndroWeb.Helpers.CartHelper.cart().dataCashPaymentDetails().sessionId);

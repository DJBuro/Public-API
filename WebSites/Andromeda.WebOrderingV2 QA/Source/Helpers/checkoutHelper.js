...
var checkoutHelper =
{
    ...
    refreshTimes: function ()
    {
        ...
        var wereSlotsRemoved = checkoutHelper.removeUnavailableDeliverySlots(slots, cartHelper.cart().cartItems(), cartHelper.cart().deals());
        ...
        (
            ...
            function (result)
            {
                    ...
                    result.data.reference != undefined)
                {
                    ...
                    cartHelper.cart().dataCashPaymentDetails(result.data);
        ...
        var orderDetails =
        {
            ...
            order:
            {
                ...
                pricing:
                {
                    ...
                    discounts: [],
                    priceAfterDiscount: cartHelper.cart().totalPrice() - (cartHelper.cart().deliveryCharge),
                    finalPrice: cartHelper.cart().totalPrice() - (cartHelper.cart().deliveryCharge),
                    deliveryCharge: cartHelper.cart().deliveryCharge
                },
                orderLines:
                [
                ],
...
// KEEP THE ORIGINAL PRICE
        ...
        if (orderDetails.paymentData !== undefined)
        {
            ...
            orderDetails.paymentData.paymentCharge = cartHelper.cart().cardCharge;
        }
